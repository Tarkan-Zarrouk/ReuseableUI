package main.feature.modules.dungeons;

import main.feature.ModuleMain;

public class Dungeons extends ModuleMain {

    public Dungeons() {
        super("DungeonsExample", Categories.DUNGEONS, false);
    ...
    public boolean isPlayerNull() {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'isPlayerNull'");
    }
